            ...
            <div key={account.id} className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  {account.pictureUrl ? (
                    ...
                    <div
                      ...
                      style={{ backgroundColor: account.isActive ? '#1C2E6E' : '#9CA3AF' }}
                    >
                ...
                <button
                  ...
                  className={`text-xs px-2 py-0.5 rounded-full ${account.isActive ? 'bg-blue-100 text-blue-700' : 'bg-gray-100 text-gray-500'}`}
                >
              ...
              <div className="grid grid-cols-3 gap-3 mb-4 py-3 border-t border-b border-gray-100">
                ...
                <div className="text-center">
                  <p className="text-lg font-bold text-blue-600">{account.stats.messagesThisMonth}</p>
